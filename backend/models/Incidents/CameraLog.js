...
const User = require('../Users/User'); // ✅ Ensure user tracking
...
const CameraLog = sequelize.define('CameraLog', {
    ...
    actionType: { // ✅ Log type
        type: DataTypes.ENUM('CREATED', 'UPDATED', 'DELETED', 'STATUS_CHANGE', 'RESTORED'),
        allowNull: false,
    },
    oldStatus: { // ✅ Previous status (if applicable)
        type: DataTypes.ENUM('online', 'offline', 'unknown'),
        allowNull: true,
    },
    newStatus: { // ✅ New status after update
        type: DataTypes.ENUM('online', 'offline', 'unknown'),
        allowNull: true,
    },
